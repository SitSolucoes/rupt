...
CREATE TABLE `pagamentos` (
  ...
  `src_comprovante` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pago` tinyint(1) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `data_pagamento` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pagamentos_leitor_idleitor_foreign` (`leitor_idLeitor`),
  KEY `pagamentos_admin_idadmin_foreign` (`admin_idAdmin`)
