...
CREATE TABLE `denuncias` (
  ...
  `motivo_idMotivo` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `denuncias_post_idpost_foreign` (`post_idPost`),
  KEY `denuncias_admin_idadmin_foreign` (`admin_idAdmin`),
  KEY `denuncias_leitor_idleitor_foreign` (`leitor_idLeitor`),
  KEY `denuncias_motivo_idmotivo_foreign` (`motivo_idMotivo`)
